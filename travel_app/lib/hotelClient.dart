...
class _MyHotelClient extends State<MyHotelClient> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
            ...
            body: (img != null && imgs != null && room != null && mci!=null && companyInfo!=null) ? ListView.builder(
                itemCount: 1,
                            ...
                            DataTable(
                                    ...
                                    <DataColumn>[
                                      ...
                                      DataColumn(
                                          label: Container(
                                            width:70,
                                            child:Text('Benefits',textAlign: TextAlign.center,)),
                                          numeric: false),
                                      DataColumn(
                                          label: Container(
                                            width:40,
                                    ...
                                    rows: List<DataRow>.generate(
                                        ...
                                        DataCell(Container(width:50,child:Text(roomSel[index].type))),
                                        DataCell(
                                            Container(width:40,child:Text(roomSel[index].price))),
                                        DataCell(Container(width:70,child:Text(roomSel[index].benefits))),
                                        DataCell(
